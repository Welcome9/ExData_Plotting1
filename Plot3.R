...
with(df, points(DateTime, Sub_metering_2, type = "l", col = "Blue"))
with(df, points(DateTime, Sub_metering_3, type = "l", col = "orange"))
legend("topright", pch = "¢w", col = c("black", "blue", "orange"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))